...
|
*/
$config['base_url'] = 'http://localhost/TaskMaster/';
// $config['base_url'] = 'https://reprint-incl-amplifier-themselves.trycloudflare.com/';

// Agar local Wi-Fi IP use kar rahe ho
// $config['base_url'] = 'http://192.168.0.156:8080/';
...
|
*/
$config['cookie_domain'] = '.ngrok-free.app';
